...
class Record(models.Model):
    email = models.OneToOneField('Users', models.DO_NOTHING, db_column='email', primary_key=True)  # The composite primary key (email, cname, disease_code) found, that is not supported. The first column is selected.
